    ...
    return (
        <motion.div layout className="flex items-center gap-x-3">
            <motion.button
                ...
                className={`addToBasket bg-customRed py-3 mt-3 rounded-full flex items-center justify-center text-white
                    gap-x-4 leading-tight font-semibold flex-1 disabled:cursor-not-allowed`}
