        ...
        <div className="productsComponent p-3">
            <div className="filterBox mb-5 flex items-center justify-between">
                ...
                <div className="left flex gap-x-3">
                    ...
                    <button
                        onClick={handleOpen}
                        className="text-lg bg-customRed p-3 text-white rounded-lg"
                    >
                        Mahsulot yaratish
                    </button>
                </div>
                    ...
                    currentProducts.map((product) => (
                        ...
                        >
                            ...
                            <div className="btnBox col-span-3 flex items-center justify-end gap-x-5">
                                <button
                                    className="bg-customRed p-2 text-white rounded-full"
                                    onClick={() => deleteProduct(product.id)}
                                >
                                    <DeleteOutlineRoundedIcon />
                                </button>
                                <button className="bg-customRed p-2 text-white rounded-full">
                                    <EditRoundedIcon />
                                </button>
                            </div>
                        </div>
